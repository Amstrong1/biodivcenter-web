...
Route::put('/individu/{id}', [IndividuController::class, 'update']);
...
Route::put('/api-sanitary-state/{id}', [APISanitaryStateController::class, 'update']);
...
Route::put('/api-alimentation/{id}', [APIAlimentationController::class, 'update']);
...
Route::put('/api-reproduction/{id}', [APIReproductionController::class, 'update']);
...
Route::put('/api-relocation/{id}', [APIRelocationController::class, 'update']);
...
Route::put('/api-observation/{id}', [APIObservationController::class, 'update']);
