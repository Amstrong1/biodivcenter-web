    ...
    <GuestLayout>
        ...
        <div class="relative flex items-center justify-center w-full">
            <div class="flex flex-col bg-white px-12 py-8 w-35-pc">
                ...
                <div class="">
                    <div class="grid grid-cols-6 items-center px-12 mt-12 gap-2">
                        <img class="w-8" src="/assets/img/evd.png" id="evd" alt="evd">
                        <img class="w-8" src="/assets/img/paas_t.png" id="paas_t" alt="paas_t">
                        <img class="w-8" src="/assets/img/sos-savane.png" id="sos-savane" alt="sos-savane">
                        <img class="w-8" src="/assets/img/logo.png" id="logo" alt="logo">
                        <img class="w-8" src="/assets/img/dera.png" id="dera" alt="dera">
                        <img class="w-8" src="/assets/img/ile-ecologique.jpg" id="ile-ecologique" alt="ile-ecologique">
                        <img class="w-8" src="/assets/img/pepiniere_d_afrique.jpg" id="pepiniere_d_afrique" alt="pepiniere_d_afrique">
                        <img class="w-8" src="/assets/img/logo.png" id="logo" alt="logo">
                        <img class="w-8" src="/assets/img/logo.png" id="logo" alt="logo">
                        <img class="w-8" src="/assets/img/logo.png" id="logo" alt="logo">
                        <img class="w-8" src="/assets/img/association_tin_ba.png" id="association_tin_ba" alt="association_tin_ba">
                        <img class="w-8" src="/assets/img/logo.png" id="logo" alt="logo">
                    </div>
