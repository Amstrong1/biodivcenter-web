    ...
    <AuthenticatedLayout>
        ...
        <div class="w-full flex flex-col mb-10 md:mb-0">
            <div class="md:col-span-5">
                <ElementsTable :csrf="$page.props.csrf" :resources="$page.props.ongs"
                    :mattributes="$page.props.my_attributes" :mactions="$page.props.my_actions" :type="'ong'" />
            </div>
        </div>
            ...
            <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0"
                ...
                <div v-show="showModal"
                    ...
                    <div class="bg-[#f1f4ef] rounded-lg p-10 max-h-[80vh] overflow-auto" style="width: 500px">
                        <span class="font-bold">Ajouter ONG</span>
